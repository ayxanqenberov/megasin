  ...
  return (
    <>
      ...
      <div className="registerContainer flex flex-col justify-center items-center gap-2 mt-4 h-[450px]">
        ...
        <span className="text-3xl font-bold max-sm:text-[20px]">
          Join the Megasin Community
        </span>
        ...
        <form className="flex flex-col gap-2 pt-4" onSubmit={handleRegister}>
          ...
          <div className="w-[300px] max-sm:w-[90%] max-sm:mx-auto relative">
            <input
              className="w-full outline-red-500 text-red-600 font-semibold placeholder:text-red-600 p-3 pr-10 rounded-[10px]"
            ...
            {showPassword ? (
              <VscEye
                ...
                className="cursor-pointer text-red-600 absolute right-[4%] top-1/2 transform -translate-y-1/2 text-lg"
              />
            ) : (
              <VscEyeClosed
                onClick={toggleShowPassword}
