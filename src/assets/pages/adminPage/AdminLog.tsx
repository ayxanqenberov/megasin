...
import { loginAdmin, logout, selectIsAdminAuthenticated, selectAdminIsLoading, selectAdminError } from "../../features/Admin/adminSlice";
...
const AdminLog = () => {
  ...
  const handleLogin = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      // Unhandled rejection xətasının qarşısını almaq üçün konsola yazdırılır
      console.error(err);
    }
  };
