...
const Profiles = () => {
  ...
  return (
    <div className="w-full flex flex-col lg:flex-row gap-8 p-6 lg:p-12 bg-gray-50">
      <section className="lg:w-1/3 w-full bg-white p-6 rounded-lg shadow-md">
        <div className="flex flex-col items-center gap-4">
          ...
          <span className="text-blue-500">{visitedUser.followerUser.length} follower</span>
        </div>
      </section>
