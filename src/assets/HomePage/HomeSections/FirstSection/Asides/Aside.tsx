    ...
    <aside className="w-[18%] max-lg:hidden   flex flex-col gap-4">
      <div
        className={
          user
            ? "hidden"
            : "usersInfo flex  flex-col items-start dark:bg-black dark:text-white  bg-white gap-2 p-3 rounded-md"
        }
      >
        <p className="text-black dark:bg-black dark:text-white font-bold text-xl">
          MEGASIN BLOG is a community of amazing users
        </p>
        <p className="text-gray-500 dark:bg-black dark:text-gray-300">
      ...
      <div
        className={
          user
            ? "flex flex-col gap-1.5 dark:bg-black dark:text-white bg-white px-4 py-2 rounded-md"
            : "hidden"
        }
      >
      ...
      <div className="bg-white flex flex-col gap-2 border-[4.5px] dark:bg-black dark:text-white border-black rounded-md px-4 py-2">
      ...
      <div className="bg-white flex flex-col dark:bg-black dark:text-white gap-2.5 rounded-md px-4 py-2">
      ...
      <div
        className={
          user
            ? "bg-white flex dark:bg-black dark:text-white flex-col pb-3 gap-2.5 rounded-md px-4 py-2"
            : "hidden"
        }
      >
        <span className="text-xl font-medium dark:bg-black dark:text-white text-gray-400">Megasin</span>
        <strong className="text-xl dark:bg-black dark:text-white text-[#404040]">
          Get Your Writing Debut Badge
        </strong>
        <p className="text-[15px] dark:bg-black dark:text-white">
      ...
      <div
        className={!user ? "bg-white flex flex-col dark:bg-black dark:text-white mb-1 gap-2.5 rounded-md px-4 py-2" : "hidden"}
      >
        <span className="text-xl font-medium dark:bg-black dark:text-white text-gray-400">Megasin</span>
        <img className="rounded-md" src={structor} alt="" />
        <div className="flex dark:bg-black dark:text-white flex-wrap">
